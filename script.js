...
const defaultHeartImages = Array.from({ length: 10 }, (_, i) => `images/img${i + 1}.jpg`);
...
const ringTexts = [
  'sayang noynoy',//untuk deskripsi planet layer 1
  "I love you",//untuk deskripsi planet layer 2
  "noya pretty <3",//untuk deskripsi planet layer 3
  "05/04/2026",//untuk deskripsi planet layer 4
...
function preloadGalaxyAudio() {
  const audioSources = [
   "https://youtu.be/tGv7CUutzqU?si=yeNKZlg_8xa-UbKI"
  ];
